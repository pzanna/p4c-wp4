...
#include "extensions/p4c-wp4/version.h"
#include "ir/ir.h"
#include "lib/log.h"
#include "lib/crash.h"
...
void compile(WP4Options& options) {
    ...
    WP4::run_wp4_backend(options, toplevel, &midend.refMap, &midend.typeMap);
}
...
int main(int argc, char *const argv[]) {
    ...
    AutoCompileContext autoWP4Context(new WP4Context);
    auto& options = WP4Context::get().options();
    options.compilerVersion = P4C_WP4_VERSION_STRING;
