...
#ifndef _BACKENDS_WP4_OPTIONS_H_
#define _BACKENDS_WP4_OPTIONS_H_

#include <getopt.h>
#include "frontends/common/options.h"

class WP4Options : public CompilerOptions {
 public:
    // file to output to
...
using WP4Context = P4CContextWithOptions<WP4Options>;

#endif /* _BACKENDS_WP4_OPTIONS_H_ */
